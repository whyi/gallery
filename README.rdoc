...
* 1. run the rubyinstaller-2.0.0-p576.exe
  - set the path to c:\row\ruby200
  - add to path
* 2. run DevKit-mingw64-32-4.7.2-20130224-1151-sfx.exe
  - set the path to c:\row\devkit
* 3. extract mysql-connector-c-noinstall-6.0.2-win32 to c:\row so that you have something like
