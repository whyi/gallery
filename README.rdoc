== windows
1. Download necessary files at http://1drv.ms/1rskvEC
2. run the rubyinstaller-2.0.0-p576.exe
* set the path to c:\row\ruby200
* add to path
3. run DevKit-mingw64-32-4.7.2-20130224-1151-sfx.exe
* set the path to c:\row\devkit
4. extract mysql-connector-c-noinstall-6.0.2-win32 to c:\row so that you have something like
...
5. run mysql-installer-web-community-5.6.20.0.exe
* select server only
